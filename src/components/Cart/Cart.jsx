...
<>
{cartlist.length!==0?<div className="flex flex-wrap p-[20px]">
<div className="relative overflow-x-auto shadow-md sm:rounded-lg sm:w-5/6 md:w-4/5">
...
<div className="sm:w-[100px] md:w-[19%] bg-white text-left h-[300px] rounded-lg p-4 flex items-center content-center fixed right-3 top-[120px]">
...
<button onClick={()=>{
  dispatch(clearCart())
  Navigate("/home")
}}className='bg-white main-color border border-green-500 text-center rounded-lg w-full block py-4'>Clear your Cart</button>
</div>
</div>
